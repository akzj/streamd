...
func TestConfigRequiresLoopbackAdmin(t *testing.T) {
	config := Config{ListenAddress: "0.0.0.0:7443", AdminAddress: "0.0.0.0:9090", DataDirectory: "/data", TLS: TLSConfig{CertificateFile: "c", PrivateKeyFile: "k", ClientCAFile: "ca"}}
